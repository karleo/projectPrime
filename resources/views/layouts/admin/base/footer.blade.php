        ...
        <div class="navi navi-spacer-x-0 p-0">
            ...
            <span class="navi-item mt-2">
						<span class="navi-link">
                            <a onclick="event.preventDefault(); document.getElementById('logout-form').submit();" href="{{ route('logout') }}" class="btn btn-sm btn-light-primary font-weight-bolder py-3 px-6">Sign Out</a>
						</span>
					</span>
            <!--end:Item-->
...
@includeIf('layouts.admin.base.scripts')
@stack('scripts')
</body>
<!--end::Body-->
</html>
